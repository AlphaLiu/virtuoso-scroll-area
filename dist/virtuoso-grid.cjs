...
var virtuoso_grid_exports = {};
__export(virtuoso_grid_exports, {
  VirtuosoGridScrollArea: () => VirtuosoGridScrollArea
});
module.exports = __toCommonJS(virtuoso_grid_exports);
...
var useIsomorphicLayoutEffect = typeof window === "undefined" ? import_react2.useEffect : import_react2.useLayoutEffect;
...
function useDebounceCallback(callback, delay) {
  ...
  (0, import_react2.useEffect)(() => () => window.clearTimeout(timerRef.current), []);
...
function useVirtualizedScrollArea({
  ...
  const resizeCallbackRef = (0, import_react12.useRef)(null);
  const scrollToIndex = (0, import_react12.useCallback)(
    (index, behavior = "smooth") => {
      virtuosoRef.current?.scrollToIndex({ index, behavior });
    },
    [virtuosoRef]
  );
  const scrollToTop = (0, import_react12.useCallback)(() => scrollToIndex(0), [scrollToIndex]);
  const scrollToBottom = (0, import_react12.useCallback)(
    () => scrollToIndex(itemCount - 1),
    [scrollToIndex, itemCount]
  );
  (0, import_react12.useImperativeHandle)(handleRef, () => ({ scrollToIndex, scrollToTop }), [
    scrollToIndex,
    scrollToTop
  ]);
  const handleScrollerRef = (0, import_react12.useCallback)(
    (element) => {
...
var GridItem = ({ children, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { ...props, children });
var GRID_EDGE_PADDING = 4;
function createGridList(gridClassName) {
  const GridList = (0, import_react13.forwardRef)(
...
var VirtuosoGridScrollArea = (0, import_react13.forwardRef)(
  ({
    totalCount,
    itemContent,
    computeItemKey,
    ...
    useInjectedStyles();
    const virtuosoRef = (0, import_react13.useRef)(null);
    ...
    const components = (0, import_react13.useMemo)(
      () => ({ List: createGridList(gridClassName), Item: GridItem, Scroller }),
      [gridClassName]
    );
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ScrollAreaContext.Provider, { value: scrollAreaContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { "data-virtualized-scroll-area": true, className: "vsa-virtualized-scroll-area", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            import_react_virtuoso.VirtuosoGrid,
            {
              ref: virtuosoRef,
          ...
          showScrollToTopButton && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            ScrollToTopButton,
            {
              scrollToTop,
              scrollToTopButtonClassName,
...
//# sourceMappingURL=virtuoso-grid.cjs.map