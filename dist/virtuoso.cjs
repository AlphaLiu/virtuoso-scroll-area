...
var virtuoso_exports = {};
__export(virtuoso_exports, {
  VirtuosoScrollArea: () => VirtuosoScrollArea
});
module.exports = __toCommonJS(virtuoso_exports);
...
function createItemComponent(itemClassName) {
  const Item = (0, import_react13.forwardRef)(
    ({ children, className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { ref, ...props, className: cx(itemClassName, className), children })
  );
  Item.displayName = "VirtuosoItem";
  return Item;
}
var VirtuosoScrollArea = (0, import_react13.forwardRef)(
  ({
    data,
    itemContent,
    className,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ScrollAreaContext.Provider, { value: scrollAreaContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { ref: setScrollArea, className: cx("vsa-scroll-area", className), children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "vsa-virtualized-area", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
...
//# sourceMappingURL=virtuoso.cjs.map